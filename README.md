...
- 🔄 **إعداد Webhook تلقائي**: يقوم البوت بإعداد webhook تلقائياً عند بدء التشغيل

> 📘 **دليل إعداد الـ Webhook**: راجع [WEBHOOK_SETUP_GUIDE.md](./WEBHOOK_SETUP_GUIDE.md) لمعرفة كيفية إعداد webhook البوت تلقائياً باستخدام دومين أو IP السيرفر.
